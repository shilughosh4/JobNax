  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarText">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link" href="job_show">View</a>
        </li>
        <li class="nav-item">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center latest-job margin-bottom-20">
            ...
            <h5 class="fw-bold" style="font-family: Garamond, serif; color:#0000FF;"><?php echo $_SESSION['emp_name'];?>, we are sorry to see you go.</h5>
            <h5 class="fw-bold" style="font-family: Garamond, serif; color:#0000FF;">Please note that deleting your account is irreversible and all the data associated with your <?php echo $_SESSION['emp_username'];?>  account will be permanently deleted.</h5>
...
?>  
<form method="post" action="emp_del_php.php">
