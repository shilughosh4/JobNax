...
<section class="vh-100" style="background-color: #B9D9EB;">
 ...
 style="font-size:29px;font-family: Cursive, Lucida Handwriting, sans-serif;color:#6F00FF">Hire Interns and Freshers faster</p>

                <form class="mx-1 mx-md-4" method="post" action="empsignup.php">

                  <div class="d-flex flex-row align-items-center mb-4">
                    <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                    <div data-mdb-input-init class="form-outline flex-fill mb-0">
                    <label class="form-label fw-bold" for="name" style="color:#0066b2">Your Name</label>
                      <input type="text" id="name" class="form-control" name="emp_name"/>
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div data-mdb-input-init class="form-outline flex-fill mb-0">
                    <label class="form-label fw-bold" for="email" style="color:#0066b2">Official Email</label>
                      <input type="email" id="email" class="form-control" name="emp_email" />
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <label class="form-label fw-bold" for="password" style="color:#0066b2">Password</label>
                      <input type="password" id="password" class="form-control" name="emp_password" />
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <label class="form-label fw-bold" for="confirm_password" style="color:#0066b2">Confirm your password</label>
                      <input type="password" id="confirm_password" class="form-control" name="con_pass"/>
                  ...
                  <div class="form-check d-flex justify-content-center mb-5">
                    ...
                    <label class="form-check-label fw-bold" for="form2Example3">
                      Already have account <a href="emplogin.php" style="text-decoration:none;">Login</a>
                    </label>
                  </div>

                  <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
     <input type="submit" data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-lg" value="Post for free" name="emp_register">
                  </div>
