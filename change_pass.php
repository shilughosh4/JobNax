...
if(isset($_POST['change_pass']))
{
    ...
    $change_pass = "select Password from jobseeker_register where Email = '$email'";
      ...
      if(!isset($error))
{
    ...
    $new_password = password_hash($new_password,PASSWORD_BCRYPT,$options);
     ...
     $result = mysqli_query($conn,"UPDATE jobseeker_register SET Password='$new_password' WHERE Email='$email'");
           if($result)
           {
