  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarText">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="reg_can.php">Registered Candidates</a>
        </li>
        <li class="nav-item">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center latest-job margin-bottom-20">
            <h3 class="fw-bold" style="font-family: Garamond, serif; color:IndianRed;">Registered Candidate</h3> 
...
<table class="table" id="datatable">
  <thead>
    <tr>
      <th scope="col" class="table-secondary">Candidate Photo</th>
      ...
      <th scope="col" class="table-secondary">Type</th>
      <th scope="col" class="table-secondary">About Candidate</th>
      <th scope="col" class="table-secondary">Highest Qualificaion</th>
      <th scope="col" class="table-secondary">Second Highest Qualificaion</th>
...
$sql = "select can.*,can_d.*,can_qua.* from candidate_details can_d
inner join jobseeker_register can on can.Id = can_d.Can_id
inner join candidate_education can_qua on can_qua.Candidate_id = can_d.Can_id ";
...
while ($total = $result->fetch_assoc()) {
    ...
    <td>".$total['Type']."</td>
    <td>".$total['About_Myself']."</td>
    <td>".$total['Four_Education_type']."</td>
    <td>".$total['Third_Education_type']."</td>
    <td>".$total['Address']."</td>
    <td>".$total['City']."</td>
    <td>".$total['State']."</td>
    <td>".$total['Pincode']."</td>
