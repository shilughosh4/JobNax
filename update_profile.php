...
<form method="post" action="update_emp.php" enctype="multipart/form-data">
<?php
      include 'connect.php';
...
<div class="row g-3 py-3">
  ...
  <label class="visually-hidden" for="name">Name</label>
    <div class="input-group">
      ...
      <input type="text" class="form-control fw-bold" value="<?php echo $_SESSION['emp_name'];?>">
    </div>
  </div>
...
<div class="col-md-6">
  ...
  <div class="col-md-6">
    ...
    <input type="text" class="form-control"  name="deg" value="<?php echo $deg;?>">
  </div>
</div>
...
<div class="row g-3 py-3">
  ...
  <label class="visually-hidden" for="com_loc">Company Location:</label>
    <div class="input-group">
      ...
      <input type="text" class="form-control" name="com_loc" value="<?php echo $com_loc;?>" >
    </div>
  </div>
...
<div class="d-grid gap-2 d-md-flex justify-content-md-center">
  <input type="submit" class="btn btn-outline-warning fw-bold" value="Update" name="Update">
</div>
